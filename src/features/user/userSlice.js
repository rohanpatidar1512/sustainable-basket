...
export const deleteOrderProduct = createAsyncThunk(
    "user/cart/delete-order",
    async(orderId,thunkAPI) => {
        try{
            return await authService.resetPass(orderId);
        } catch (error) {
            return thunkAPI.rejectWithValue(error)
        }
    }
...
//         try{
//             return await authService.makePayment(paymentData);
//         } catch (error) {
//             return thunkAPI.rejectWithValue(error)
//         }
//     }
...
export const authSlice = createSlice({
    ...
    extraReducers: (builder) =>{
        ...
        .addCase(deleteOrderProduct.fulfilled, (state, action) => {
            ...
            state.isError = false;
            state.isSuccess = true;
            state.deletedOrderProduct = action.payload;
            if(state.isSuccess){
